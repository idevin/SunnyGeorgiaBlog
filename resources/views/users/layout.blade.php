  ...
  <div class="col-md-3 mb-3">
    <div class="card">
      ...
      <div class="list-group list-group-flush">
        <a href="{{ routeLink('users.edit') }}" class="list-group-item {{ ($tab == 'profile') ? 'active' : '' }}">
          <i class="fa fa-user" aria-hidden="true"></i> @lang('users.profile')
        </a>

        <a href="{{ routeLink('users.password') }}" class="list-group-item {{ ($tab == 'security') ? 'active' : '' }}">
          <i class="fa fa-lock" aria-hidden="true"></i> @lang('users.security')
        </a>

        <a href="{{ routeLink('users.token') }}" class="list-group-item {{ ($tab == 'api_token') ? 'active' : '' }}">
