    ...
    <div class="row justify-content-md-center">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <a class='btn btn-link' href="{{routeLink('password.update')}}">{{__('auth.forgotten_password')}}</a>
            </div>
            {!! Form::close() !!}
            ...
            <div class="d-flex justify-content-between flex-wrap">
                @if (env('GITHUB_ID'))
                    <a href="{{ routeLink('auth.provider', ['provider' => 'github']) }}" class="btn btn-secondary mb-2">
                ...
                @if (env('TWITTER_ID'))
                    <a href="{{ routeLink('auth.provider', ['provider' => 'twitter']) }}" class="btn btn-secondary mb-2">
