    ...
    <div class="page-header mt-5">
        ...
        <div class="section">
            ...
            <div class="section-title text-center mb-4">
                <h1>@lang('posts.search_title')</h1>
            </div>

            {!! Form::open(['url' => routeLink('posts.search'), 'class' => 'd-flex justify-content-center align-items-stretch', 'method' => 'GET']) !!}
            <div class="input-group mr-sm-3" style="width: 80%;">
                {!! Form::text('q', null, ['class' => 'form-control', 'placeholder' => __('posts.search')]) !!}
            </div>

            <button class="search-icon" style="border: none; background: none;">
        ...
        <div class="container">
            @if(count($posts) > 0)
                @include ('posts/_search_list', ['posts' => $posts])
            <div class="paginator">
                {{$posts->links()}}
            </div>
