<table class="table table-responsive-md">
    <caption>{{ trans_choice('tags.count', $posts->total()) }}</caption>
    <thead>
    <tr>
        <th>@lang('tags.attributes.title')</th>
        <th>@lang('tags.attributes.author')</th>
        <th>@lang('tags.attributes.posted_at')</th>
    ...
    @foreach($posts as $post)
        <tr>
            <td>
                <a href="{{routeLink('admin.tags.edit', $post->id)}}">
            ...
            <td>
                <a href="{{ routeLink('admin.tags.edit', $post) }}" class="btn btn-primary btn-sm">
                    <i class="fa fa-pencil" aria-hidden="true"></i>
                </a>

                {!! Form::model($post, ['method' => 'DELETE', 'url' => routeLink('admin.tags.destroy', $post), 'class' => 'form-inline', 'data-confirm' => __('forms.tags.delete'), 'data-form-id' => $post->id]) !!}
