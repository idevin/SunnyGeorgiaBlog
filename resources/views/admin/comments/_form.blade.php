{!! Form::model($comment, ['url' => routeLink('admin.comments.update', $comment), 'method' =>'PUT' ]) !!}
...
<div class="pull-left">
    <a href="{{routeLink('admin.comments.index')}}" class="btn btn-secondary">
...
{!! Form::model($comment, ['method' => 'DELETE', 'url' => routeLink('admin.comments.destroy', $comment), 'class' => 'form-inline pull-right', 'data-confirm' => __('forms.comments.delete')]) !!}
